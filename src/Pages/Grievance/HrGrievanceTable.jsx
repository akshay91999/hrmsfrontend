...
const columns = [
  ...
  { field: "date", width: 180, headerClassName: "super-app-theme--header",headerAlign: 'center' },
  { field: "grievance", width: 300, headerClassName: "super-app-theme--header",headerAlign: 'center' },
