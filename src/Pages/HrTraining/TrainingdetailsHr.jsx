...
// function createData(employeeid,employeename,department,trainingname,trainer,timeschedule) {
//   return { employeeid,employeename,department,trainingname,trainer,timeschedule};
// }

// const rows = [
//   createData('ITA056','a','it','aaaaaaaaaaa','ghbhb',4),
//   createData('ITA056','b','it','bbbbbbbbbbbbb','hbhbh','4'),
//   createData('ITA056','c','it','ccccccccc','huhuhu','4'),
//   createData('ITA056','d','it','dddddddddddddd','huhuh','4'),
//   createData('ITA056','e','it','eeeeeeeeeee','bhhhy','4'),
//   createData('ITA056','f','it','fffffffffff','rfrr',4),
//   createData('ITA056','g','it','ggggggggggggg','wdwe',4),
//   createData('ITA056','h','it','hhhhhhhhhhhhh','eww',4),
//   createData('ITA056','i','it','iiiiiiiiiiii','yhrtg',4),
//   createData('ITA056','j','it','jjjjjjjjjjjjjj','ngb',4),
//   createData('ITA056','k','it','kkkkkkkkk','wedwqe',4),
//   createData('ITA056','l','it','llllllllllll','ewefw',4),
//   createData('ITA056','m','it','mmmmmmmmmmmm','vdffdvs',4),
//   createData('ITA056','n','it','nnnnnnnnnn','gegef',4),
//   createData('ITA056','o','it','oooooooo','rfewv',4),
//   createData('ITA056','p','it','pppppppppppppppp','efqewf',4),
//   createData('ITA056','q','it','qqqqqqqqqqqqq','rgegeg',4),
 
// ];

// export default function TrainingdetailsHr() {
